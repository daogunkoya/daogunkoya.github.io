...
var RecipeEffects = /** @class */ (function () {
    function RecipeEffects(actions$, httpClient, store) {
        ...
        this.recipeStore = this.actions$
            ...
            var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpRequest"]('PUT', 'https://ng-recipe-book-3adbb.firebaseio.com/recipes.json', state.recipes, { reportProgress: true });
